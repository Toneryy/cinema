    ...
    <main className={m.main}>
      <section className={s.planSection}>
        ...
        <h4 className={s.subTitle}>
          ...
          each thoughtfully designed to cater to the distinct preferences and
          viewing habits of our diverse customer base.
        </h4>
        <div className={s.container}>
          <div className={s.cardItem}>
            ...
            <div className={s.advantages}>
              <div className={s.advantage}>
                <FcCheckmark /> Unlock unlimited access to our vast movie
                library, including new releases and exclusive content.
              </div>
              <div className={s.advantage}>
            ...
            <button
              onClick={() => {
                navigateToLink(navigate, "/subscription/basic");
              }}
          ...
          <div className={s.cardItem}>
            ...
            <div className={s.advantages}>
              ...
              <div className={s.advantage}>
                <FcCheckmark /> Watch on up to four devices at the same time,
                making it perfect for families or friends.
              </div>
              <div className={s.advantage}>
                <FcCheckmark /> Get access to movies before they hit theaters or
                other streaming services.
              </div>
              <div className={s.advantage}>
                <FcCheckmark /> Create and share your movie playlists with your
                friends.
              </div>
            </div>
            <button
              onClick={() => {
                navigateToLink(navigate, "/subscription/premium");
              }}
              className={s.getStarted}
            >
              Get Started
          ...
          <div className={s.cardItem}>
            ...
            <div className={s.advantages}>
              <div className={s.advantage}>
                <FcCheckmark /> All features and benefits of the Basic
                Subscription and Premium Subscription.
              </div>
              <div className={s.advantage}>
                <FcCheckmark /> Gain access to our exclusive director's cuts,
                behind-the-scenes footage, and original movies.
              </div>
              <div className={s.advantage}>
                <FcCheckmark /> Enjoy priority customer support available 24/7.
              </div>
              <div className={s.advantage}>
                <FcCheckmark /> Receive an annual limited-edition movie poster
                from a featured film.
              </div>
            </div>
            <button
              onClick={() => {
                navigateToLink(navigate, "/subscription/ultimate");
              }}
              className={s.getStarted}
            >
              Get Started
