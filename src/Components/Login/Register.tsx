  ...
  return (
    <section className={s.login}>
      <div className={s.content}>
        ...
        <h4 className={s.subtitle}>Register now and start exploring a world of movies</h4>
        <form className={s.form} onSubmit={handleSubmit}>
          ...
          <button className={s.loginButton} type="submit">Register</button>
        </form>
        <p className={s.registerText}>
          Already have an account? <NavLink to="/login" className={s.registerRoute}>Sign In</NavLink>
        </p>
